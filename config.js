module.exports = {
  OWNER_IDS: [946464064035500053, 852927374625472522], // Bot owner ID's
  PREFIX: "*", // Default prefix for the bot
  SUPPORT_SERVER: "https://discord.gg/nhPUquz8sq", // Your bot support server
  PRESENCE: {
    ENABLED: true, // Whether or not the bot should update its status
    STATUS: "online", // The bot's status [online, idle, dnd, invisible]
    TYPE: "WATCHING", // Status type for the bot [PLAYING | LISTENING | WATCHING | COMPETING]
    MESSAGE: "{members} members in Meme Team", // Your bot status message
  },
  DASHBOARD: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "997630634858123344", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
